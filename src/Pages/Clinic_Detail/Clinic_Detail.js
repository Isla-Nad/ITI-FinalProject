        ...
        <div className="container">
          <div className="row">
            <div className="text text-center mt-5 mb-5">
              <h2 style={{fontSize:"3rem",color:"darkblue"}} className="mb-5">Elegance Dental Clinic</h2>
            </div>
            <div className="mt-5">
        ...
        <div className="container">
          ...
          <div className="mt-5 row text-center">
            <div className="col-3 mt-4">
              <a href=""><img style={{width:"10rem",height:"10rem"}} src="https://www.chsica.org/wp-content/uploads/2020/10/Facebook-Logo-PNG-Transparent-Like-17-300x300.png"/></a>
            </div>
            <div className="col-3 mt-4">
              <a href=""><img style={{width:"10rem",height:"10rem"}} src="https://img.freepik.com/premium-vector/modern-badge-logo-instagram-icon_578229-124.jpg"/></a>
            </div>
            <div className="col-3 mt-4">
              <a href=""><img style={{width:"10rem",height:"10rem"}} src="https://static-00.iconduck.com/assets.00/linkedin-icon-2048x2048-ya5g47j2.png"/></a>
            </div>
            <div className="col-3 mt-4">
              <a href=""><img style={{width:"10rem",height:"10rem"}} src="https://upload.wikimedia.org/wikipedia/commons/f/f2/Logo_Twitter.png"/></a>
            </div>
          </div>
          <div className="mt-5 row text-center">
            <div className="col-6 mt-4">
              ...
              <span style={{fontSize:"1.3rem"}}>Our Number : </span><span>0123456789</span> 
            ...
            <div className="col-6 mt-4">
              ...
              <span style={{fontSize:"1.3rem"}}>Our Location : </span><span>6 Ali Mubarak St. Asyut</span> 
