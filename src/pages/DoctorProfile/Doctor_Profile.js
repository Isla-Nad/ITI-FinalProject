                        ...
                        <div className="col-lg-3 col-md-5 col-sm-12 position-fixed" id="sidebar">
                            ...
                            <ul className="list-group mb-4" id="sidebar-nav-1">
                                <li className="list-group-item list-group-item-primary" style={{width:"20rem"}}>
                                    <a className="nav-link ms-3 my-1 text-black" href="#profile"><FontAwesomeIcon icon={faUserNurse} size="2xl" /><span className='ms-4'>Profile</span></a>
                                </li>
                                <li className="list-group-item list-group-item-primary" style={{width:"20rem"}}>
                                    <a className="nav-link ms-3 my-1 text-black" href="#About"><FontAwesomeIcon icon={faAddressCard} size="2xl" /><span className='ms-4'> About Dentist</span></a>
                                </li>
                                <li className="list-group-item list-group-item-primary" style={{width:"20rem"}}>
                                    <a className="nav-link ms-3 my-1 text-black" href="#Certificates"><FontAwesomeIcon icon={faCertificate} size="2xl" /><span className='ms-4'> Certificates</span></a>
                                </li>                                        
                                <li className="list-group-item list-group-item-primary" style={{width:"20rem"}}>
                                    <a className="nav-link ms-3 my-1 text-black" href="#Cases"><FontAwesomeIcon icon={faBriefcaseMedical} size="2xl" /><span className='ms-4'>Cases</span> </a>
                                </li>
                                <li className="list-group-item list-group-item-primary" style={{width:"20rem"}}>
                                    <a className="nav-link ms-3 my-1 text-black" href="#Contacts"><FontAwesomeIcon icon={faPhone} size="2xl" /><span className='ms-4'>Contacts</span> </a>
                                </li>                                        
                                <li className="list-group-item list-group-item-primary" style={{width:"20rem"}}>
                                    <a className="nav-link ms-3 my-1 text-black" href="#Rate"><FontAwesomeIcon icon={faStar} size="2xl" /><span className='ms-4'> Ratings & Reviews</span> </a>
                                </li>                                       
                            </ul>   
                        </div>
                        <div className="col-lg-8 col-md-7 col-sm-12 mt-5" style={{margin:"25rem"}}>
                            <div data-bs-spy="scroll" data-bs-target="#sidebar-nav-1" data-bs-smooth-scroll="true" className="scrollspy-example" tabindex="0">
                                        ...
                                        <div id="Certificates" className="mt-5">
                                            ...
                                            <div className="container">
                                                <div className="row">
                                                    <a href="https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg" target="blank" className="col-lg-3 col-md-6 col-sm-12"><img style={{width:"100%"}} src="https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg" /></a>
                                                    <a href="https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg" target="blank" className="col-lg-3 col-md-6 col-sm-12"><img style={{width:"100%"}} src="https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg" /></a>
                                                    <a href="https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg" target="blank" className="col-lg-3 col-md-6 col-sm-12"><img style={{width:"100%"}} src="https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg" /></a>
                                                    <a href="https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg" target="blank" className="col-lg-3 col-md-6 col-sm-12"><img style={{width:"100%"}} src="https://marketplace.canva.com/EAFIEvneNCM/1/0/1600w/canva-golden-elegant-certificate-of-appreciation-0bN-aLORS9U.jpg" /></a>
                                                </div>
                                        ...
                                        <div id="Cases" className="mt-5">
                                            ...
                                            <div className="container">
                                                <div className="row">
                                                    <a href="https://clinicalmastery.com/wp-content/uploads/2017/12/Copy-of-Pre-op-4-768x644-1.png" target="blank" className="col-lg-3 col-md-6 col-sm-12"><img style={{width:"100%"}} src="https://clinicalmastery.com/wp-content/uploads/2017/12/Copy-of-Pre-op-4-768x644-1.png" /></a>
                                                    <a href="https://clinicalmastery.com/wp-content/uploads/2017/12/Copy-of-Pre-op-4-768x644-1.png" target="blank" className="col-lg-3 col-md-6 col-sm-12"><img style={{width:"100%"}} src="https://clinicalmastery.com/wp-content/uploads/2017/12/Copy-of-Pre-op-4-768x644-1.png" /></a>
                                                    <a href="https://clinicalmastery.com/wp-content/uploads/2017/12/Copy-of-Pre-op-4-768x644-1.png" target="blank" className="col-lg-3 col-md-6 col-sm-12"><img style={{width:"100%"}} src="https://clinicalmastery.com/wp-content/uploads/2017/12/Copy-of-Pre-op-4-768x644-1.png" /></a>
                                                    <a href="https://clinicalmastery.com/wp-content/uploads/2017/12/Copy-of-Pre-op-4-768x644-1.png" target="blank" className="col-lg-3 col-md-6 col-sm-12"><img style={{width:"100%"}} src="https://clinicalmastery.com/wp-content/uploads/2017/12/Copy-of-Pre-op-4-768x644-1.png" /></a>
                                                </div>
