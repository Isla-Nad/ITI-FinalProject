        ...
        <div className="col-md-6 card custom-card">
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="form-group">
              <label>
                <input type="radio" value="patient" className="form-check-input" checked={role === "patient"} onChange={handleRoleChange} />
                Patient
              </label>
              <span>&nbsp; &nbsp; &nbsp;</span>
              <label>
                <input type="radio" value="doctor" className="form-check-input" checked={role === "doctor"} onChange={handleRoleChange} />
                Doctor
              </label>
            </div>
            <div className="form-group">
              ...
              <>
                <div className="form-group">
                  ...
                  <select className="form-control" id="clinic">
                    ...
                    <option value="Cilinc 1">Cilinc 1</option>
                    <option value="Cilinc 1">Cilinc 2</option>
                  </select>
                </div>
                {/* add an image */}
                <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="password" className="form-control" id="confirmPassword" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} placeholder="Confirm Password" required />
